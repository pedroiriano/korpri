                        ...
                        @foreach($announcement as $item)
                            <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                                ...
                                <div class="content p-6">
                                    <a href="/pengumuman/detail/{{ $item['slug_title'] }}" class="title h5 text-lg font-medium hover:text-blue-korpri duration-500 ease-in-out">
                                        {{ $item['slug_title'] }}
                                    </a>
                                    ...
                                    <div class="mt-4">
                                        <a href="/pengumuman/detail/{{ $item['slug_title'] }}" class="btn btn-link font-normal hover:text-blue-korpri after:bg-blue-korpri duration-500 ease-in-out">
