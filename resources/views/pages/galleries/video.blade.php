            ...
            <div class="lg:col-span-4 md:col-span-6">
                <div class="sticky top-20">
                    ...
                    <div class="flex items-center justify-center mt-4">
                        <div class="ml-3">
                            <a href="{{ route('photo') }}" class="font-semibold hover:text-blue-korpri" aria-selected="false">
                                Galeri Foto
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center mt-4">
                        <div class="ml-3">
                            <a href="{{ route('video') }}" class="font-semibold hover:text-blue-korpri" aria-selected="true">
                                Galeri Video
                            </a>
                        </div>
                    </div>
